...
Quan el potencial de membrana assoleix el llindar $V_{ref}$, la neurona emet un pols (\textit{spike}) i el potencial es reinicia a un valor $V_{reset}$:
...
\begin{figure}[H]
	...
	\caption{Evolució temporal del potencial de membrana $V(t)$ en una neurona IF i generació de spikes en superar el llindar $V_{ref}$.}
...
De manera anàloga al cas IF, una representació temporal del potencial de membrana i dels spikes associats, com la mostrada a la \autoref{fig:lif_waveform}, resulta especialment útil per evidenciar l’efecte de la fuita i la relaxació del potencial entre entrades consecutives.

\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\textwidth]{lif_waveform.png}
	\caption{Evolució temporal del potencial de membrana $V(t)$ en una neurona LIF, mostrant l’efecte de la fuita i la generació de spikes. Font: \cite{lee2020spikebased}}
