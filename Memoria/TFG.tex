...
\newpage
\begin{lstlisting}[style=logs, caption={Fragment de la codificació per taxa de les entrades, paràmetres interns i sortides}, captionpos = b, label={lst:Codificacio_entrada}]
...
\vspace{3mm}
\begin{lstlisting}[style=logs, caption={Fragment de la implementacio de la classe SNN utilitzada i conversió de pesos i biaixos de l'ANN a l'SNN}, captionpos = b, label={lst:Normalitzacio_pesos}]
class SNN():
