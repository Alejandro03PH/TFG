...
class Classificador(nn.Module):
    def __init__(self, n_entrada = 2, n_sortida = 1, n_oculta = 6): # Configurem les neurones d'entrada, sortida i ocultes.
        ...
        self.net = nn.Sequential( # Definim la xarxa neuronal com una seqüència de capes.
            ...
            nn.Linear(n_oculta, n_sortida),   # Capa oculta → Capa oculta
            nn.ReLU()                # Funció d'activació ReLU
        )
...
if __name__ == '__main__':
    ...
    def log_print(message):
        with open('Xarxa neuronal/Classificador/entrenament_log.txt', 'a') as f:
            f.write(f'{message}\n')
        print(f'{message}')
